export default {
  route: {
    ...
    library: 'Thư viện',
    libraryCategory: 'Danh mục',
    libraryQuestion: 'Danh sách',
    libraryExercises: 'Bài tập',
    question: 'Câu hỏi',
    exams: 'Bài thi',
    news: 'Tin tức',
    demo: 'Bản giới thiệu',
  ...
  error: {
    ...
    min_length: 'Tối phiểu phải từ {min} ký tự',
  ...
  message_box: {
    ...
    importSuccess: 'Nhập thành công <b>{number}</b>/<b>{total}</b> bản ghi'
  },
  navbar: {
    dashboard: 'Dashboard',
    github: 'Github',
  ...
  category: {
    title_question: 'Nhóm câu hỏi',
    title_news: 'Nhóm tin tức',
  ...
  question: {
    ...
    answers: 'Đáp án',
    answerInput: 'Nhập đáp án',
    answerHelper: 'Chọn tích vào đáp án đúng',
    msgPushWrong: 'Có tổng số <b>{total}</b> bản ghi không hợp lệ.',
    msgPushWrongDetails: 'Chi tiết vị trí: ',
    successImport: 'Các vị trí câu hỏi nhập thành công',
    errorImport: 'Các vị trí câu hỏi nhập lỗi',
  ...
  exercises: {
    ...
    numberTest: 'Số lần làm bài',
    mixQuestion: 'Trộn câu hỏi',
    mixAnswer: 'Trộn đáp án',
    totalQuestion: 'Tổng số câu hỏi',
    eligible: 'Đủ điều kiện',
    time: 'Thời gian làm',
    users: 'Thí sinh',
    selectUser: 'Chọn người dùng',
    noData: 'Hiện chưa có bài thi, vui lòng quay lại sau'
  },
  exams: {
    title: 'Danh sách bài thi',
    start: 'Bắt đầu thi',
    numberTest: 'Số lần làm bài còn lại',
    numberDid: 'Số lần đã làm',
    timeDid: 'Thời gian đã làm',
    timeLeft: 'Thời gian còn lại',
    startConfirm: 'Bắt đầu tính giờ làm bài',
    submit: 'Nộp bài',
    submitConfirm: 'Bạn có chắc chắn muốn kết thúc bài thi?',
