      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="price_discount" :props="props">
            <span
              class="q-pr-xs">{{ props.row.price_discount|NumberFormat($store.getters.language) }}</span>
            <q-badge v-html="props.row.price_unit" color="red" transparent />
          </q-td>
          <q-td key="price_import" :props="props">
            <span
              class="q-pr-xs">{{ props.row.price_import|NumberFormat($store.getters.language) }}</span>
            <q-badge v-html="props.row.price_unit" color="teal" transparent />
          </q-td>
          <q-td key="price_export" :props="props">
            <span
              class="q-pr-xs">{{ props.row.price_export|NumberFormat($store.getters.language) }}</span>
            <q-badge v-html="props.row.price_unit" color="teal" transparent />
          </q-td>
