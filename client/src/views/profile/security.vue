<template>
  <q-card flat bordered class="my-card">
    <q-card-section class="row">
      <div class="text-subtitle2 text-bold self-center">
        {{ $t("profile.security") }}
      </div>
      <q-space />
        ...
        <div class="row q-gutter-xs">
          <div class="col-12 col-md-6">
            ...
            <q-input v-model.trim="oldPassword.value" :type="oldPassword.type"
              ...
              @keyup.native="oldPassword.caps = checkCapslock($event)"
              @blur="oldPassword.caps = false" :rules="[v=>!!v||$t('error.required')]"
              class="capsTooltip">
        ...
        <div class="row q-gutter-xs">
          <div class="col-12 col-md-6">
            ...
            <q-input v-model.trim="newPassword.value" :type="newPassword.type"
              ...
              @keyup.native="newPassword.caps = checkCapslock($event)"
              @blur="newPassword.caps = false" :rules="[v=>!!v||$t('error.required')]"
              class="capsTooltip">
              <template v-slot:append>
        ...
        <!-- <div class="row q-gutter-xs">
          <div class="col-12 col-md-6">
            <q-input v-model.trim="rePassword.value" :type="rePassword.type" :dense="$store.getters.dense.input"
              ...
              @blur="rePassword.caps=false" :rules="[v=>!!v||$t('error.required')]" class="capsTooltip">
              <template v-slot:append>
